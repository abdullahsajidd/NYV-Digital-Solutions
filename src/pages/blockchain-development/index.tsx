...
const index = () => {
  return (
    <>
      <Head>
        <title>Blockchain Development | Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Discover our cutting-edge blockchain development services at Code UpScale. We provide innovative solutions for secure and decentralized applications."
          key="desc"
        />
      </Head>
