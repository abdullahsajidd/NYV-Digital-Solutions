...
const index = () => {
  return (
    <>
      <Head>
        <title>Game Development | Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Code UpScale excels in game development. Join us in crafting immersive, entertaining, and interactive games that captivate your audience."
          key="desc"
        />
      </Head>
