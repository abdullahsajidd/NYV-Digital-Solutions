...
function index() {
  return (
    <div>
      <Head>
        <title>About | Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
        <meta
          name="description"
          content="Discover the heart of Code UpScale LLC through our 'About Us' page. Explore our journey, values, and commitment to excellence in software, AI, and blockchain development."
          key="desc"
        />
      </Head>
      <AboutBanner />
