...
const index = () => {
  return (
    <>
      <Head>
        <title>Salesforce Solutions | Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Elevate your business with Code UpScale's Salesforce development services. We harness the capabilities of this CRM platform for growth."
          key="desc"
        />
      </Head>
