...
const index = () => {
  return (
    <>
      <Head>
        <title>DevOps | Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Experience seamless IT operations with Code UpScale's DevOps services. Our strategies optimize your development, deployment, and delivery processes."
          key="desc"
        />
      </Head>
