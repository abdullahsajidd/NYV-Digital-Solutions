...
const index = () => {
  return (
    <>
    <Head>
        <title>Web Development | Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" Code UpScale LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Code UpScale LLC's web development services focus on crafting responsive, user-friendly websites. Discover how we bring your online presence to life."
          key="desc"
        />
      </Head>
